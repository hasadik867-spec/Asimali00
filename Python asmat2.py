...
texts = ['               Telegram Channel :- mrfadi786', '                Tool Status :- Paid', '              Script Type :- SafeUm Account Maker', '              Script Expire Time :- Unlimted', '              Script Owner Telegram Id :- @mrfadi316 ', '             Script Price :- 5$']
...
webbrowser.open("https://t.me/mrfadi786")
...
def work():
    ...
    try:
        ...
        if '"status":"Success"' in gzip:
            ...
            print(b)
            with open('Mr_Fadi.txt', 'a') as f:
                f.write(username + ":hugg | TG : @mrfadi786\n")
